...
class Arguments:
    ...
    def output_asm_be(self, yaml):
        ...
        ind = str_indent(4)
        output(ind, "def __init__(self, op, ")
        ...
        if label_fields != 0:
            ...
            output(str_indent(4), "def resolve_br_label(self, all_labels, addr):\n")
...
def output_asm_be_parse_fn(decode_scope, toppat, yaml):
    ...
    for n in sorted(arguments.keys()):
        ...
        output(str_indent(12) + "insns.append({}Instruction(t, ".format(arg.name.upper()))
        output(list_to_seperated_str(arg.fields, ", "))
        output("))\n")
    output(str_indent(8) + "else:\n")
    output(str_indent(12) + "self.parser.print_error(\"Invalid insn '{}'\".format(t))\n")
